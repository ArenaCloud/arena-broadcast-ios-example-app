...
+ (CineAppDelegate*)appDelegate {
    return (CineAppDelegate*)[[UIApplication sharedApplication] delegate];
}
...
//    [GlobalWebSocketManager sharedInstance].ipAndPort = @"192.168.1.1:8080";
